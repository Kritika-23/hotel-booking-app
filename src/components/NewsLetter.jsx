  ...
  return (
    <div className=" py-12 flex md:flex-row flex-col border border-gray-500/30 rounded-lg items-start md:items-center justify-between gap-5 text-sm max-w-5xl mx-auto bg-white p-8">
            <div className="max-w-md w-full">
                <h1 className="text-3xl font-semibold text-[#2c0850] ">Subscribe to our newsletter</h1>
                ...
                <div className="flex items-center gap-4 mt-10">
                    ...
                    <button className="bg-[#8458B3] hover:bg-[#c296f1] transition-all px-6 py-2 rounded text-white font-medium">Subscribe</button>
                </div>
            </div>
            <div className="space-y-4 md:max-w-48">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-medium text-[#2c0850] ">Weekly articles</h3>
                </div>
            ...
            <div className="space-y-4 md:max-w-48">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-medium text-[#2c0850]"> No spam </h3>
                </div>
