    ...
    <div className="py-12 flex flex-wrap items-center justify-center gap-6 pt-14">
      ...
      >
        <div className="flex flex-col items-center px-5 py-4 relative">
          ...
          <div className="pt-8 text-center">
            <h1 className="text-lg font-medium text-[#2c0850] ">Donald Jackman</h1>
      ...
      >
        <div className="flex flex-col items-center px-5 py-4 relative">
          ...
          />
          <div className="pt-8 text-center">
            <h1 className="text-lg font-medium text-[#2c0850] ">Richard Nelson</h1>
      ...
      >
        <div className="flex flex-col items-center px-5 py-4 relative">
          ...
          />
          <div className="pt-8 text-center">
            <h1 className="text-lg font-medium text-[#2c0850] ">James Washington</h1>
